...
<head>
    ...
    <title>Book Keeper - Reports</title>
...
<body>
    ...
    <div class="floating-nav">
        <button class="btn btn-primary rounded-circle" type="button" data-bs-toggle="offcanvas"
            data-bs-target="#quickNav" aria-controls="quickNav">
                                ...
                                <div class="card info-card sales-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ps-3">
                                                <h6>₱
                                                    <?php echo number_format($summaryStats['ors']['total_amount'] ?? 0, 2); ?>
                                                </h6>
                                                <span class="text-success small pt-1 fw-bold">Total:
                                                    <?php echo number_format($summaryStats['ors']['total_ors'] ?? 0); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card info-card revenue-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ps-3">
                                                <h6>₱
                                                    <?php echo number_format($summaryStats['dv']['total_amount'] ?? 0, 2); ?>
                                                </h6>
                                                <span class="text-success small pt-1 fw-bold">Total:
                                                    <?php echo number_format($summaryStats['dv']['total_dv'] ?? 0); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-striped table-hover datatable">
                                            ...
                                            <tbody>
                                                <?php foreach ($recentTransactions as $transaction): ?>
                                                    <tr>
                                                        <td><?php echo date('Y-m-d', strtotime($transaction['date'])); ?>
                                                        </td>
                                                        <td><?php echo $transaction['type']; ?></td>
                                                        <td><?php echo htmlspecialchars($transaction['reference_no']); ?>
                                                        </td>
                                                        <td>₱ <?php echo number_format($transaction['total_amount'], 2); ?>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($fundDistribution as $fund): ?>
                                                                ...
                                                                ?>
                                                                <tr>
                                                                    <td><?php echo htmlspecialchars($fund['fund_cluster_name']); ?>
                                                                    </td>
                                                                    <td>₱ <?php echo number_format($fund['budget'], 2); ?>
                                                                    </td>
                                                                    <td>₱
                                                                        <?php echo number_format($fund['actual_amount'], 2); ?>
                                                                    </td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="generateOrsSummaryBtn">Generate
                            Report</button>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="list-group">
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#orsSummaryModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>ORS Summary Report
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#orsByPayeeModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>ORS by Payee
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#orsByFundClusterModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>ORS by Fund Cluster
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#orsByServiceModal">
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <div class="list-group">
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#dvSummaryModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>DV Summary Report
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#dvByPayeeModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>DV by Payee
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#dvByFundClusterModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>DV by Fund Cluster
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#dvByServiceModal">
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <div class="list-group">
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#jevSummaryModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>JEV Summary Report
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#jevByAccountModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>JEV by Account Title
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#jevByFundClusterModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>JEV by Fund Cluster
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#jevByServiceModal">
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <div class="list-group">
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#monthlySummaryModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>Monthly Summary
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#quarterlySummaryModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>Quarterly Summary
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#annualSummaryModal">
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <div class="list-group">
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#budgetUtilizationModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>Budget Utilization
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#budgetVsActualModal">
                                                    <i class="bi bi-file-earmark-text me-2"></i>Budget vs. Actual
                                                </a>
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#remainingBudgetModal">
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <div class="list-group">
                                                ...
                                                <a href="#" class="list-group-item list-group-item-action"
                                                    data-bs-toggle="modal" data-bs-target="#savedReportsModal">
