...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>OO4.1.2-OBLIGATION(<?php echo date('Y'); ?>) - <?php echo htmlspecialchars($oopap_description); ?></h1>
        </div><!-- End Page Title -->
        ...
        <section class="section dashboard">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <form method="get" action="oo4_1_2_obligation.php" class="row g-3">
                        <div class="col-md-4">
    ...
    <script>
        function filterByMonth(month) {
            if (month) {
                window.location.href = 'oo4_1_2_obligation.php?month=' + month;
            } else {
                window.location.href = 'oo4_1_2_obligation.php';
            }
        }
    </script>
