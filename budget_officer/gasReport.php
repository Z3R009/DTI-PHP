...
<head>
    ...
    <title>GAS Reports - Budget System</title>
...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">GAS Reports</li>
                </ol>
            </nav>
        </div>
        ...
        <section class="section dashboard">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">GAS Report for <?php echo $months[$selected_month] . ' ' . $selected_year; ?></h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="7"><strong>MOOE</strong></td>
                                </tr>
                    ...
                    <style type="text/css" media="print">
                        @media print {
                            ...
                            .btn, .datatable-top, .datatable-bottom, .back-to-top {
