  ...
  <ul class="sidebar-nav nav flex-column" id="sidebar-nav">
        <li class="nav-item">
            ...
            <div class="nav-divider"></div>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="bi bi-wallet  "></i><span>STATUS OF FUND</span>
                    </a>

                    <li>
                        <a class="nav-link collapsed" data-bs-target="#personal-nav" data-bs-toggle="collapse" href="#">
                            <i class=""></i><span>PERSONNEL SERVICES</span><i class="bi bi-chevron-down ms-auto"></i>
                        </a>
                    ...
                    <li>
                        <a class="nav-link collapsed" data-bs-target="#mooe-nav" data-bs-toggle="collapse" href="#">
                            <i class=""></i><span>MOOE</span><i class="bi bi-chevron-down ms-auto"></i>
                        </a>
                    ...
                    <li>
                        <a class="nav-link collapsed" data-bs-target="#carp-fund-nav" data-bs-toggle="collapse" href="#">
                            <i class=""></i><span>CARP</span><i class="bi bi-chevron-down ms-auto"></i>
                        </a>
                    ...
                    <li>
                        <a class="nav-link collapsed" data-bs-target="#rapid-fund-nav" data-bs-toggle="collapse" href="#">
                            <i class=""></i><span>RAPID GROWTH PROJECT</span><i class="bi bi-chevron-down ms-auto"></i>
                        </a>
            ...
            <div class="nav-divider"></div>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="bi bi-bag-check"></i><span>OBLIGATION</span>
                    </a>
            ...
            <div class="nav-divider"></div>
                <li class="nav-item">
                    <a class="nav-link" href="budgetOfficerSummaryReport.php">
                        <i class="bi bi-bar-chart-line"></i><span>SUMMARY REPORT</span>
                    </a>
...
<style>
    ...
    .sidebar-nav .nav-content i.bi-circle {
        font-size: 8px;
        margin-right: 8px;
        color: #344767;
        transition: all 0.3s ease;
    ...
    .sidebar-nav .nav-link.collapsed i.bi-chevron-down {
        transition: transform 0.3s ease;
    }

    .sidebar-nav .nav-link:not(.collapsed) i.bi-chevron-down {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        collapseLinks.forEach(link => {
            link.addEventListener('click', function(e) {
                ...
                // Toggle show class with transition
                if (targetContent) {
