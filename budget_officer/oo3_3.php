...
$total_allotment_query = "SELECT SUM(allotment) AS total_allotment FROM project WHERE oopap_id = 7";
...
$total_balances_query = "SELECT SUM(balances) AS total_balances FROM project WHERE oopap_id = 7";
...
<body>
    ...
    <script>
        function deleteUser(oo3_3ID) {
            if (confirm("Are you sure you want to delete this oo3_3?")) {
                window.location.href = 'delete_oo3_3.php?project_id=' + oo3_3ID + '&confirm=yes';
            }
        }
    </script>
