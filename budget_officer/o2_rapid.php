...
$select = mysqli_query(
    ...
    "SELECT project.*,
        ...
        $oopap_query = "SELECT description FROM oopap WHERE oopap_id = 15";
...
<head>
    ...
    <title>O2-RAPID LP 2024 CONTINUING - Rapid LP 2024 Continuing</title>
...
<body>
    ...
    <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            ...
            <form method="get" action="o2_rapid.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="o2_rapid.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset to current month and year" id="resetFilter">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_SOF.php">
                        ...
                        <input type="hidden" name="redirect" value="o2_rapid.php">
    ...
    <script>
        function deleteUser(o2_rapidID) {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'o2_rapid.php?project_id=' + o2_rapidID + '&confirm=yes';
                }
            });
        }
