...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <h5 class="card-title">SUMMARY OF OBLIGATION (OO3-2) <?php echo $months[$selected_month] . ' ' . $selected_year; ?></h5>
                    <form method="get" action="oo3_2Report.php" class="row g-3">
                        <div class="col-md-4">
