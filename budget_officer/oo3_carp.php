...
$select = mysqli_query(
    ...
    "SELECT project.*,
        ...
        $oopap_query = "SELECT description FROM oopap WHERE oopap_id = 13";
        ...
        $total_allotment_query = "SELECT SUM(allotment) AS total_allotment FROM project WHERE oopap_id = 13 AND YEAR(created_at) = $selected_year";
        ...
        $total_balances_query = "SELECT SUM(balances) AS total_balances FROM project WHERE oopap_id = 13 AND YEAR(created_at) = $selected_year";
...
<body>
    ...
    <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            <div>
                <h1>OO3-Carp <?php echo date('Y'); ?></h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="index.php">Status of Fund</a></li>
                        <li class="breadcrumb-item"><a href="index.php">Carp</a></li>
                        <li class="breadcrumb-item active">OO3</li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex align-items-center">
            <form method="get" action="oo3_carp.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="oo3_carp.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset to current month and year" id="resetFilter">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_SOF.php">
                        ...
                        <input type="hidden" name="redirect" value="oo3_carp.php">
    ...
    <script>
        function deleteUser(oo3_carpID) {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'oo3_carp.php?project_id=' + oo3_carpID + '&confirm=yes';
                }
            });
        }
