...
$total_allotment_query = "SELECT SUM(allotment) AS total_allotment FROM project WHERE oopap_id = 14";
...
$total_balances_query = "SELECT SUM(balances) AS total_balances FROM project WHERE oopap_id = 14";
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>O1-RAPID RO 12(<?php echo date('Y'); ?>)</h1>
        </div><!-- End Page Title -->
    ...
    <script>
        function deleteUser(rapidID) {
            if (confirm("Are you sure you want to delete this O1-RAPID RO 12?")) {
                window.location.href = 'o1_rapidRO12.php?project_id=' + rapidID + '&confirm=yes';
            }
        }
    </script>
