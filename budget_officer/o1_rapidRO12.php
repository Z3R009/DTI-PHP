...
<head>
    ...
    <title>O1-RAPID LP 2024 CONTINUING - Rapid LP 2024 Continuing RO 12</title>
...
<body>
    ...
    <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            <div>
                <h1>O1-RAPID LP 2024 CONTINUING - Rapid LP 2024 Continuing RO 12 <?php echo date('Y'); ?></h1>
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">O2-Rapid LP 2024 Continuing RO 12</li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex align-items-center">
            <form method="get" action="o1_rapidRO12.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="o1_rapidRO12.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset to current month and year" id="resetFilter">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_SOF.php">
                        ...
                        <input type="hidden" name="redirect" value="o1_rapidRO12.php">
    ...
    <script>
        function deleteUser(o1_rapidRO12ID) {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'o1_rapidRO12.php?project_id=' + o1_rapidRO12ID + '&confirm=yes';
                }
            });
        }
