...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
        <h1>O2-RAPID(<?php echo date('Y'); ?>) - <?php echo htmlspecialchars($oopap_description); ?></h1>
        </div><!-- End Page Title -->
        ...
        <section class="section dashboard">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <form method="get" action="o2_rapidObligation.php" class="row g-3">
                        <div class="col-md-4">
    ...
    <script>
        function filterData() {
            ...
            let url = 'o2_rapidObligation.php?year=' + year;
            if (month) {
                url += '&month=' + month;
            }
