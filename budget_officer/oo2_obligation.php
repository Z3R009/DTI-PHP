...
$oopap_id = 3; // Set the oopap_id to 3 as requested
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>OO2-OBLIGATIONOBLIGATION(<?php echo date('Y'); ?>) - <?php echo htmlspecialchars($oopap_description); ?></h1>
        </div><!-- End Page Title -->
        ...
        <section class="section dashboard">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <form method="get" action="oo2_obligation.php" class="row g-3">
                        <div class="col-md-4">
