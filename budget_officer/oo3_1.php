...
if (isset($_POST['submit'])) {
    $oo3_1_id = $_POST['oo3_1_id'];
    $project = $_POST['project'];
    $uacs_code = $_POST['uacs_code'];
    $allotment = $_POST['allotment'];

    $sql = "INSERT INTO oo3_1_allotment (oo3_1_id, project, uacs_code, allotment) VALUES (?, ?, ?, ?)";
    $stmt = $connection->prepare($sql);
    $stmt->bind_param("isss", $oo3_1_id, $project, $uacs_code, $allotment);
...
$select = mysqli_query($connection, "SELECT * FROM oo3_1_allotment ");
?>

<?php
// Fetch total allotment
$total_allotment_query = "SELECT SUM(allotment) AS total_allotment FROM oo3_1_allotment";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary edit-btn" data-bs-toggle="modal"
                                            data-bs-target="#editModal" data-id="<?php echo $row['oo3_1_id']; ?>"
                                        ...
                                        <button type="button" class="btn btn-danger"
                                            onclick="deleteUser(<?php echo $row['oo3_1_id']; ?>)"><i class="bi bi-trash"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_oo3_1.php">
                        <input type="hidden" id="edit_oo3_1_id" name="oo3_1_id">
                        <div class="mb-3">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            editButtons.forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    document.getElementById("edit_oo3_1_id").value = id;
    ...
    <script>
        function deleteUser(oo3_1ID) {
            if (confirm("Are you sure you want to delete this OO3.1?")) {
                window.location.href = 'delete_oo3_1.php?oo3_1_id=' + oo3_1ID + '&confirm=yes';
            }
        }
    </script>
