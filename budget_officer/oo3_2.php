...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO oo3_2_allotment (oo3_2_id, project, uacs_code, allotment) VALUES (?, ?, ?, ?)";
    $stmt = $connection->prepare($sql);
    $stmt->bind_param("isss", $oo3_2_id, $project, $uacs_code, $allotment);
...
$select = mysqli_query($connection, "SELECT * FROM oo3_2_allotment ");
?>

<?php
// Fetch total allotment
$total_allotment_query = "SELECT SUM(allotment) AS total_allotment FROM oo3_2_allotment";
...
<body>
                                    ...
                                    <form method="post" id="addUserForm">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="project" name="project"
                                                placeholder="Enter Project" required autocomplete="off">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="allotment" class="form-control" id="allotment" name="allotment"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary edit-btn" data-bs-toggle="modal"
                                            data-bs-target="#editModal" data-id="<?php echo $row['oo3_2_id']; ?>"
                                        ...
                                        <button type="button" class="btn btn-danger"
                                            onclick="deleteUser(<?php echo $row['oo3_2_id']; ?>)"><i class="bi bi-trash"
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_oo3_2.php">
                        <input type="hidden" id="edit_oo3_2_id" name="oo3_2_id">
                        <div class="mb-3">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            editButtons.forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    document.getElementById("edit_oo3_2_id").value = id;
    ...
    <script>
        function deleteUser(oo3_2ID) {
            if (confirm("Are you sure you want to delete this OO3.2?")) {
                window.location.href = 'delete_oo3_2.php?oo3_2_id=' + oo3_2ID + '&confirm=yes';
            }
        }
    </script>
