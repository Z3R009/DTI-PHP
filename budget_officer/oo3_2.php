...
$oopap_query = "SELECT description FROM oopap WHERE oopap_id = 6";
...
$total_allotment_query = "SELECT SUM(allotment) AS total_allotment FROM project WHERE oopap_id = 6 AND YEAR(created_at) = $selected_year";
...
$total_balances_query = "SELECT SUM(balances) AS total_balances FROM project WHERE oopap_id = 6 AND YEAR(created_at) = $selected_year";
...
<head>
    ...
    <title>OO3.2-OTOP Next Gen</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            <div>
                <h1>OO3.2-OTOP NEXT GEN  <?php echo date('Y'); ?></h1>
                <nav>
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        ...
                        <li class="breadcrumb-item active">OO3.2</li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex align-items-center">
           
                <form method="get" action="oo3_2.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="oo3_2.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset to current month and year" id="resetFilter">
                    ...
                    <form method="post" id="addUserForm">
                        <div class="mb-3">
                            <input type="hidden" class="form-control" id="oopap_id" name="oopap_id"
                                value="6" readonly required autocomplete="off">
                        </div>
                        <div class="mb-3">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_SOF.php">
                        ...
                        <input type="hidden" id="edit_account_id" name="edit_account_id">
                         ...
                         <input type="hidden" name="redirect" value="oo3_2.php">
        ...
        function deleteUser(oo3_2ID) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'oo3_2.php?project_id=' + oo3_2ID + '&confirm=yes';
                }
            });
        }
