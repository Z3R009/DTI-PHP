...
$oopap_id = 11; // Set the oopap_id to 12 as requested
...
<body>
        ...
        <section class="section dashboard">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <form method="get" action="oo1_personalServicesObligation.php" class="row g-3">
                        <div class="col-md-4">
    ...
    <script>
        function filterData() {
            ...
            let url = 'oo1_personalServicesObligation.php?year=' + year;
            if (month) {
                url += '&month=' + month;
            }
