...
$oopap_query = "SELECT description FROM oopap WHERE oopap_id = 3";
...
<head>
    ...
    <title>OO2-Industry Development Program</title>
...
<body>
    ...
    <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            <div>
                <h1>OO2-INDUSTRY DEVELOPMENT PROGRAM<?php echo date('Y'); ?></h1>
                <nav>
                    <ol class="breadcrumb">
        ...
        <div class="row mb-4">
            ...
            <div class="card-body p-4">
                    ...
                    <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#addUserModal" style="width: 180px; background-color:#023e8a;" data-bs-toggle="tooltip" data-bs-placement="top" title="Add new project/program/activities">
