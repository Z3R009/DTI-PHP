...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO oo2_allotment (oo2_id, project, uacs_code, allotment) VALUES (?, ?, ?, ?)";
    $stmt = $connection->prepare($sql);
    $stmt->bind_param("isss", $oo2_id, $project, $uacs_code, $allotment);
...
$select = mysqli_query($connection, "SELECT * FROM oo2_allotment ");
?>

<?php
// Fetch total allotment
$total_allotment_query = "SELECT SUM(allotment) AS total_allotment FROM oo2_allotment";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary edit-btn" data-bs-toggle="modal"
                                            data-bs-target="#editModal" data-id="<?php echo $row['oo2_id']; ?>"
                                        ...
                                        <button type="button" class="btn btn-danger"
                                            onclick="deleteUser(<?php echo $row['oo2_id']; ?>)"><i class="bi bi-trash"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_oo2.php">
                        <input type="hidden" id="edit_oo2_id" name="oo2_id">
                        <div class="mb-3">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            editButtons.forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    document.getElementById("edit_oo2_id").value = id;
    ...
    <script>
        function deleteUser(oo2ID) {
            if (confirm("Are you sure you want to delete this OO2?")) {
                window.location.href = 'delete_oo2.php?oo2_id=' + oo2ID + '&confirm=yes';
            }
        }
    </script>
