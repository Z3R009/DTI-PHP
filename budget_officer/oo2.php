    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                ...
                <form method="get" action="oo2.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="oo2.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset to current month and year" id="resetFilter">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_SOF.php">
                        ...
                        <input type="hidden" id="edit_account_id" name="edit_account_id">
                         ...
                         <input type="hidden" name="redirect" value="oo2.php">
