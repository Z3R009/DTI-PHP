...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>OO4_1_2 - <?php echo htmlspecialchars($description); ?></h1>
        </div><!-- End Page Title -->
        ...
        <section class="section dashboard">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <form method="get" action="oo4_1_2.php" class="row g-3">
                        <div class="col-md-4">
    ...
    <script>
        function deleteUser(oo4_1_2ID) {
            if (confirm("Are you sure you want to delete this OO4_1_2?")) {
