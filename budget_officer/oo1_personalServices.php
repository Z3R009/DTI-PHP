...
$total_allotment_query = "SELECT SUM(allotment) AS total_allotment FROM project WHERE oopap_id = 11";
...
$total_balances_query = "SELECT SUM(balances) AS total_balances FROM project WHERE oopap_id = 11";
...
<body>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_oo1_personalServices.php">
    ...
    <!-- delete -->
    <script>
        function deleteUser(personalID) {
            if (confirm("Are you sure you want to delete this OO1-PERSONNEL SERVICES?")) {
                window.location.href = 'oo1_personalServices.php?project_id=' + personalID + '&confirm=yes';
            }
        }
    </script>
