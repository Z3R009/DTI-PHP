...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2025 at 04:09 AM
...
(116, 3, 11, '2025-04-25', 'ADMINPOLICY-25-04-006', 17, 'Meals', 'To Payment of', 1, 342, 1, 20000.00, 1, 'CONNIE M. BARNACHEA', 'Pending');
...
(87, 1, 342, 500000.00, 480000.00, '2025-03-31'),
...
(378, 1, 379, 100000.00, 99300.00, '2025-04-02'),
(379, 1, 380, 100000.00, 100000.00, '2025-04-02'),
(380, 1, 381, 0.00, -469.00, '2025-04-02'),
...
--
ALTER TABLE `ors`
  MODIFY `ors_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;
