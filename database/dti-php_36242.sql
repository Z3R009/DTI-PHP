...
INSERT INTO `dv` (`dv_id`, `date`, `ors_id`, `account_id`, `dv_no`, `vat`, `vat_amount`, `tax_base`, `tax_1`, `tax_1_amount`, `tax_2`, `tax_2_amount`, `net_amount`, `total_amount`, `chief_accountant`, `regional_director`, `status`) VALUES
(54, '2025-04-15', 68, 1, '1-25-04-001', 12.00, 0.00, 111.00, 0.00, 0.00, 0.00, 0.00, 111.00, 111.00, 'NEIL ANTHONY T. MORALA', 'FLORA D. POLITUD-GABUNALES, CESO V', 'Endorsed'),
(55, '2025-04-15', 68, 1, '1-25-04-002', 12.00, 0.00, 111.50, 0.00, 0.00, 0.00, 0.00, 111.50, 111.50, 'NEIL ANTHONY T. MORALA', 'FLORA D. POLITUD-GABUNALES, CESO V', 'Pending'),
(56, '2025-04-15', 68, 1, '1-25-04-003', 12.00, 0.00, 111.50, 0.00, 0.00, 0.00, 0.00, 111.50, 111.50, 'NEIL ANTHONY T. MORALA', 'FLORA D. POLITUD-GABUNALES, CESO V', 'Pending');
...
(25, 54, 379, 'debit', 111.00),
(26, 54, 382, 'credit', 111.00),
(27, 55, 379, 'debit', 111.50),
(28, 55, 382, 'credit', 111.50),
(29, 56, 379, 'debit', 111.50),
(30, 56, 264, 'debit', 1.00),
(31, 56, 382, 'credit', 112.50);
...
(17, '2025-04-15', 54, 68, '1-25-04-001', 'JINNARD B. LUBATON', 'NEIL ANTHONY T. MORALA');
...
(68, 3, 11, '2025-04-15', 'ADMINPOLICY-25-04-002', 25, 'qqq', 'To Payment of', 1, 379, 1, 111.50, 5, 'CONNIE M. BARNACHEA', 'Endorsed'),
(69, 3, 6, '2025-04-15', 'LD-25-04-001', 20, 'fghsgfhsf', 'To Payment of', 1, 318, 1, 1044.00, 4, 'CONNIE M. BARNACHEA', 'Pending');
...
(66, 1, 357, 125000.00, 124989.00, '2025-03-31'),
...
(378, 1, 379, 100000.00, 98856.00, '2025-04-02'),
...
--
ALTER TABLE `dv`
  MODIFY `dv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT for table `dv_history`
--
ALTER TABLE `dv_history`
  MODIFY `dvhis_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `dv_non_ors`
--
ALTER TABLE `dv_non_ors`
  MODIFY `dv_non_ors_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ors`
  MODIFY `ors_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
