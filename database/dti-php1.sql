...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2025 at 03:03 AM
...
CREATE TABLE `dv` (
  ...
  `mode_payment` varchar(100) DEFAULT NULL,
  `payee_name` varchar(255) DEFAULT NULL,
  `tin_no` varchar(50) DEFAULT NULL,
  `address` varchar(255) DEFAULT NULL,
  `notes` text DEFAULT NULL,
  `rc_id` int(11) DEFAULT NULL,
  `oopap_id` int(11) DEFAULT NULL,
  ...
  `budget_officer` varchar(255) DEFAULT NULL,
...
--
ALTER TABLE `ors`
  MODIFY `ors_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `dv`
  ADD CONSTRAINT `dv_ibfk_1` FOREIGN KEY (`fund_cluster_id`) REFERENCES `fund_cluster` (`fund_cluster_id`),
  ADD CONSTRAINT `dv_ibfk_2` FOREIGN KEY (`rc_id`) REFERENCES `responsibility_center` (`rc_id`),
  ADD CONSTRAINT `dv_ibfk_3` FOREIGN KEY (`oopap_id`) REFERENCES `oopap` (`oopap_id`),
  ADD CONSTRAINT `dv_ibfk_4` FOREIGN KEY (`approver_id`) REFERENCES `approver` (`approver_id`);
