...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2025 at 06:21 AM
...
(378, 1, 379, 100000.00, 98889.00, '2025-04-02'),
...
--
ALTER TABLE `dv`
  MODIFY `dv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `ors`
  MODIFY `ors_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
