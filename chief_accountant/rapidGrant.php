...
if (isset($_GET['draft_id']) && $_GET['confirm'] == 'yes') {
    ...
    if ($stmtUser->execute()) {
        ...
        header('Location: rapidGrant.php');
        exit();
    } else {
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            <div>
                <h1>DTI RAPID LOAN GRANT <?php echo date('Y'); ?></h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="index.php">DTI Grant</a></li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex align-items-center">

                <form method="get" action="rapidGrant.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="rapidGrant.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="addUserForm">
                        <div class="mb-3">
                            <input type="hidden" class="form-control" id="account_id" name="account_id" value="8"
                                readonly required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="account_display"
                                value="DTI RAPID GRANT" readonly>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_draft.php">
                        ...
                        <input type="hidden" name="redirect" value="rapidGrant.php"> <!-- change value to current page -->
        ...
        function deleteUser(draft_id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'rapidGrant.php?draft_id=' + draft_id + '&confirm=yes';
                }
            });
        }
