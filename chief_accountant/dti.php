...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            <div>
                <h1>DTI  <?php echo date('Y'); ?></h1>
               
            </div>
            <div class="d-flex align-items-center">

                <form method="get" action="dti.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="dti.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="addUserForm">
                        <div class="mb-3">
                            <input type="hidden" class="form-control" id="account_id" name="account_id" value="10"
                                readonly required>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_draft.php">
                        ...
                        <input type="hidden" name="redirect" value="dti.php"> <!-- change value to current page -->
        ...
        function deleteUser(draft_id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'dti.php?draft_id=' + draft_id + '&confirm=yes';
                }
            });
        }
