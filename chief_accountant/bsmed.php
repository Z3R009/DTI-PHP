...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            <div>
                <h1>BSMED<?php echo date('Y'); ?></h1>
                <nav>
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="index.php">BSMED</a></li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex align-items-center">
                ...
                <form method="get" action="bsmed.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="bsmed.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset to current month and year" id="resetFilter">
                ...
                <div class="modal-body">
                    <form method="post" id="addUserForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="account_display" value="DTI BSMED_RTCXII_ADMIN EXPENSEFUND FOR CFIDP IMPLEMENTATION" readonly>
                        </div>
