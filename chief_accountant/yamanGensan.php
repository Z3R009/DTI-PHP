        ...
        <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                ...
                <form method="get" action="yamanGensan.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="yamanGensan.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip"
                    ...
                    <form method="post" id="addUserForm">
                        ...
                        <div class="mb-3">
                            <label for="account_display" class="form-label">Account Name <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="account_display" value="DTI YAMAN GENSAN"
                                readonly>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_draft.php">
                        ...
                        <input type="hidden" name="redirect" value="yamanGensan.php">
                        <!-- change value to current page -->
