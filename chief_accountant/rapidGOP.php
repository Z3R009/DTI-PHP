        ...
        <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                ...
                <form method="get" action="rapidGOP.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="rapidGOP.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip"
                    ...
                    <form method="post" id="addUserForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="account_display"
                                value="DTI XI RAPID GOP COUNTERPART - EMDS" readonly>
                        </div>
