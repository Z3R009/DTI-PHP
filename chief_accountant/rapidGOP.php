                ...
                <div class="modal-body">
                    <form method="post" id="addUserForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="account_display" value="DTI XI RAPID GOP COUNTERPART - EMDS" readonly>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_draft.php">
                        ...
                        <input type="hidden" name="redirect" value="rapidGOP.php"> <!-- change value to current page -->
        ...
        function deleteUser(draft_id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'rapidGOP.php?draft_id=' + draft_id + '&confirm=yes';
                }
            });
        }
