...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            <div>
                <h1>MSMEDC <?php echo date('Y'); ?></h1>
                <nav>
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="index.php">MSMEDC</a></li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex align-items-center">
           
                <form method="get" action="msmedc.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="msmedc.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset to current month and year" id="resetFilter">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="fw-medium"><?php echo htmlspecialchars($row['payee']); ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                ...
                <div class="modal-body">
                    <form method="post" id="addUserForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="account_display" value="DTI XI MSMEDC" readonly>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_draft.php">
                        ...
                        <input type="hidden" name="redirect" value="msmedc.php"> <!-- change value to current page -->
        ...
        function deleteUser(draft_id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'msmedc.php?draft_id=' + draft_id + '&confirm=yes';
                }
            });
        }
