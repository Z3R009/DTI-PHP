...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            <div>
                <h1>DTI TRUST FUND <?php echo date('Y'); ?></h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="index.php">DTI Trust Fund</a></li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex align-items-center">
                ...
                <form method="get" action="trust_fund.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="trust_fund.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="addUserForm">
                        <div class="mb-3">
                            <input type="hidden" class="form-control" id="account_id" name="account_id" value="5"
                                readonly required>
                        </div>
