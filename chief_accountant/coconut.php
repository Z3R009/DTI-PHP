        ...
        <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                ...
                <form method="get" action="coconut.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="coconut.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="addUserForm">
                        <div class="mb-3">
                            <input type="hidden" class="form-control" id="account_id" name="account_id" value="3"
                                readonly required>
                        </div>
