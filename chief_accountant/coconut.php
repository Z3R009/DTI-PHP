    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle page-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                ...
                <form method="get" action="coconut.php" class="d-flex align-items-center me-3 filter-form">
                    ...
                    <a href="coconut.php" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset to current month and year" id="resetFilter">
                ...
                <div class="modal-body">
                    <form method="post" id="addUserForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="account_display" value="DTI COCONUT LEVY FUND" readonly>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="editUserForm" action="update_draft.php">
                        ...
                        <input type="hidden" name="redirect" value="coconut.php"> <!-- change value to current page -->
        ...
        function deleteUser(draft_id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'coconut.php?draft_id=' + draft_id + '&confirm=yes';
                }
            });
        }
