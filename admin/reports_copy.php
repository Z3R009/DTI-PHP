                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Total Allotment <span>| This Month</span> </h5>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Total Obligations <span>| This Month</span></h5>

                                    <div class="d-flex align-items-center">

                                        <div class="ps-3">
                                            <h6>₱117,914,726.52</h6>
                                            <span class="text-success small pt-1 fw-bold">69% of total allotment</span>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Total Balances <span>| This Month</span> </h5>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>₱53,033,318.56</h6>
                                            <span class="text-success small pt-1 fw-bold">31% remaining</span>
                                            <span class="text-muted small pt-2 ps-1"></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Total Discrepancy<span>| This Month</span> </h5>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>₱72,288,233.96</h6>
                                            <span class="text-success small pt-1 fw-bold">Allotment per FAR</span>
                                            <span class="text-muted small pt-2 ps-1"></span>
                                        </div>
                                    </div>
                                </div>
